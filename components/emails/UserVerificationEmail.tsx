...
export const UserVerificationEmail = ({ token }: UserVerificationEmailProps) => (
  <Html>
    <Head />
    <Tailwind>
      <Body className="mx-auto bg-white font-sans">
        <Container className="rounded-lg  p-8 shadow-lg">
          ...
          <Button href={`${baseUrl}/sign-up/activate/${token}`} className="rounded-md bg-purple-700 px-4 py-6 font-bold text-white">
            Activate Account
          </Button>
        </Container>
      </Body>
